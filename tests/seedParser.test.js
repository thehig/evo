import { parseSeed } from "../src/seedParser";
...
describe("parseSeed", () => {
    ...
    it("should handle invalid diet character, defaulting diet and using other valid parts of 7-char seed", () => {
        ...
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.UNKNOWN);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.movementSpeed).toBe(1);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.VISION);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.activityCycle).toBe(ActivityCycle.DIURNAL);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionRange).toBe(1);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionAngle).toBe(0);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionArc).toBe(0);
    });
    it("should handle invalid movement speed character, defaulting speed in 7-char seed", () => {
        const attributes = parseSeed("HASN500");
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.HERBIVORE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.movementSpeed).toBe(1); // Default
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.SCENT);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.activityCycle).toBe(ActivityCycle.NOCTURNAL);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionRange).toBe(5);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionAngle).toBe(0);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionArc).toBe(0);
    });
    it("should handle out-of-range movement speed, defaulting speed in 7-char seed", () => {
        ...
        expect(attributes2 === null || attributes2 === void 0 ? void 0 : attributes2.movementSpeed).toBe(1);
    });
    it("should handle invalid perceptionType character, defaulting type in 7-char seed", () => {
        const attributes = parseSeed("H1XN100");
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.HERBIVORE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.movementSpeed).toBe(1);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.NONE); // Default
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.activityCycle).toBe(ActivityCycle.NOCTURNAL);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionRange).toBe(1);
    });
    it("should handle out-of-range perceptionRange, defaulting range in 7-char seed", () => {
        ...
        expect(attributes2 === null || attributes2 === void 0 ? void 0 : attributes2.perceptionRange).toBe(1);
    });
    it("should handle invalid activity cycle character, defaulting to NONE in 7-char seed", () => {
        const attributes = parseSeed("H1VX100");
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.activityCycle).toBe(ActivityCycle.NONE); // Default
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.HERBIVORE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.movementSpeed).toBe(1);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.VISION);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionRange).toBe(1);
    ...
    it("should handle lowercase characters for all parts of the 7-char seed", () => {
        ...
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.HERBIVORE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.movementSpeed).toBe(2);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.VISION);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.activityCycle).toBe(ActivityCycle.DIURNAL);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionRange).toBe(2);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionAngle).toBe(0);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionArc).toBe(0);
    });
});
describe("parseSeed: 7-character seed with complex perception", () => {
    ...
    it("defaults invalid Perception Type (char 2) to NONE", () => {
        ...
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionType).toBe(PerceptionType.NONE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.dietType).toBe(DietType.HERBIVORE);
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionArc).toBe(360);
    });
    ...
    it("defaults invalid Perception Angle (char 5) to 0 degrees", () => {
        ...
        expect(attributes2 === null || attributes2 === void 0 ? void 0 : attributes2.perceptionAngle).toBe(0);
    });
    it("defaults invalid Perception Arc (char 6) to 45 degrees", () => {
        const attributes = parseSeed("H1VD10X"); // X is invalid arc multiplier
        expect(attributes === null || attributes === void 0 ? void 0 : attributes.perceptionArc).toBe(45);
        const attributes2 = parseSeed("H1VD109"); // 9 is out of range for arc multiplier (0-8)
        expect(attributes2 === null || attributes2 === void 0 ? void 0 : attributes2.perceptionArc).toBe(45);
    });
